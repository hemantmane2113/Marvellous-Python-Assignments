...
def ExtensionExtract(DirectoryName1,DirectoryName2,Ext_Name):
...
def main():
    ...
    if(len(sys.argv)== 4):
        ...
        if((sys.argv[1] == '--h') or(sys.argv[1] == '--H')):
            ...
            print("<ScriptName.py>  <Directory Name1>    <Directory Name12>  <Extension Name> ")
        else:
